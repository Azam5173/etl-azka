"""
Testing the S3BucketConnector method
"""
import os
import unittest
import boto3
...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_list_files_prefix_ok(self):
        """
        Tests the list_files_prefix method for getting 2 file keys 
        ...
        # Method execution
        list_result = self.s3_bucket_conn.list_files_prefix(prefix_exp)
    ...
    def test_list_files_prefix_wrong(self):
        """
        Tests the test_list_files_prefix method in case of a 
        wrong or not existing prefix
        """
        # Test init
        prefix = 'no-prefix/'
        # Method execution
        list_result = self.s3_bucket_conn.list_files_prefix(prefix)
        # Test after method execution
